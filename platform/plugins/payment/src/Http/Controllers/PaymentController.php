...
class PaymentController extends SettingController
{
    ...
    {
        Assets::addScriptsDirectly('vendor/core/plugins/payment/js/payment.js?v=20260403-delete-all-transactions');
    ...
    {
        if (is_in_admin(true) && config('core.base.general.demo_mode', false)) {
            ...
            Payment::query()
                ...
                ->chunkById(100, function ($payments): void {
                    foreach ($payments as $payment) {
                        ...
                        DeletedContentEvent::dispatch($payment::class, request(), $payment);
                    }
                });
        });
